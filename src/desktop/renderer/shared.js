const I18N = {
  en: {
    ...
    updates: 'Updates',
    updateIdle: 'Browser Bridge checks for updates automatically.',
    ...
    updateCurrent: 'Browser Bridge {version} is up to date.',
  ...
  'zh-CN': {
    ...
    updates: '更新',
    updateIdle: 'Browser Bridge 会自动检测更新。',
    checkUpdates: '检查更新',
    restartInstall: '重启并安装',
    updateChecking: '正在检查更新...',
    updateAvailable: '发现新版本 {version}，正在下载...',
    updateDownloading: '正在下载更新 {progress}%。',
    updateDownloaded: '新版本 {version} 已准备好安装。',
    updateCurrent: 'Browser Bridge {version} 已是最新版本。',
    updateFailed: '检查更新失败。',
    settingsEyebrow: '设置',
    browserPaths: '浏览器路径',
